...
// // import { getFavorites, setFavorites } from "@/lib/local_storage_utils";
...
//   //   setFavorites(updatedFavourites); // Save to localStorage
//   // };
...
//     //             const favEvent = drillData.find((drill) => drill.id === favId);
//     //             return favEvent ? (
//     //               <li
//     //                 key={favEvent.id}
//     //                 className="py-2 cursor-pointer"
//     //                 onClick={() => handleListItemClick(favEvent.id)}
//     //               >
//     //                 {favEvent.title}
//     //               </li>
//     //             ) : null;
